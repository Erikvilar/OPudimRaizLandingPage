    ...
    <section className={css.AboutComponent} id="sobre">
      ...
      <div className={css.AboutContent}>
        <div className={css.About}>
		  ...
		  <a href="#produtos"><button>Nossos produtos</button></a>
        </div>
